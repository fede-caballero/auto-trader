...
def get_normalization_params():
    ...
    """
    processed_file = "data/processed/BTCUSDT_4h_processed.csv"
...
def get_signal():
    ...
    raw_file = "data/raw/BTCUSDT_4h_live_raw.csv"
    processed_file = "data/processed/BTCUSDT_4h_live_processed.csv"
    
    out_raw = preparer.download_binance_klines("BTCUSDT", "4h", limit=200)
...
def predict_latest_market():
    print("=== Auto-Trader Inference Engine ===")
    ...
    print("\n--- INFERENCE RESULTS ---")
    print(f"Current BTC/USDT Price  : ${result['price']:,.2f}")
